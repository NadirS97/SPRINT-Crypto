...
img =Image.open("C:/Users/nadir/Desktop/sprint-crypto-26/Ecran/ecran.png")
w,h=img.size
...
for i in range(h):
    ...
    maskR.save('C:/Users/nadir/Desktop/sprint-crypto-26/Ecran/Y.png')
    maskG.save('C:/Users/nadir/Desktop/sprint-crypto-26/Ecran/X.png')
    maskB.save('C:/Users/nadir/Desktop/sprint-crypto-26/Ecran/Z.png')
    maskRGB.save('C:/Users/nadir/Desktop/sprint-crypto-26/Ecran/YXZ.png')
