...
def main():
    ...
    padding = pad(len(msg))
    print(len(msg)+len(padding))

    digest_init = MD4(msg).hexdigest()

    padding_msg = pad(len(msg))
    msg_padd = msg + padding_msg
    digest_msg_padd = MD4(msg_padd).hexdigest()
    ...
    # else:
    #     messages = [b"sprint", b"The quick brown fox jumps over the lazy dog", b"BEES"]
    #     known_hashes = [
